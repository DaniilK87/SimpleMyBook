package com.daniilk87.simplebook.ui.customview
...
import com.daniilk87.simplebook.extensions.dip
...
class ColorCircleView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    @ColorRes var strokeColorRes: Int = R.color.color_black
        set(value) {
            field = value
    ...
    init {
        ...
        strokeColorRes = a.getResourceId(R.styleable.ColorCircleView_strokeColor, R.color.color_black)
        a.recycle()
    }
